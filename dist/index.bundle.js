...
module.exports = __webpack_require__.p + "assets/images/fruition-slide-0.PNG";
...
module.exports = __webpack_require__.p + "assets/images/fruition-slide-1.PNG";
...
module.exports = __webpack_require__.p + "assets/images/fruition-slide-2.PNG";
...
module.exports = __webpack_require__.p + "assets/images/jsleeve-slide-0.PNG";
...
module.exports = __webpack_require__.p + "assets/images/jsleeve-slide-1.PNG";
...
module.exports = __webpack_require__.p + "assets/images/jsleeve-slide-2.PNG";
...
;// CONCATENATED MODULE: ./src/modules/setNavLinksEvents.js
...
/* harmony default export */ const modules_setNavLinksEvents = (setNavLinksEvents);
;// CONCATENATED MODULE: ./src/modules/setHighlightTextEvent.js
...
/* harmony default export */ const modules_setHighlightTextEvent = (setHighlightTextEvent);
;// CONCATENATED MODULE: ./src/modules/onScrollInit.js
...
/* harmony default export */ const modules_onScrollInit = (onScrollInit);
;// CONCATENATED MODULE: ./src/modules/toggleMobileNav.js
...
/* harmony default export */ const modules_toggleMobileNav = (toggleMobileNav);
;// CONCATENATED MODULE: ./src/modules/fixNav.js
const fixNav = () => {
...
/* harmony default export */ const modules_fixNav = (fixNav);
;// CONCATENATED MODULE: ./src/modules/setModal.js
...
/* harmony default export */ const modules_setModal = (setModal);
// EXTERNAL MODULE: ./src/assets/images/slides/fruition-slide-0.PNG
var fruition_slide_0 = __webpack_require__(527);
var fruition_slide_0_default = /*#__PURE__*/__webpack_require__.n(fruition_slide_0);
// EXTERNAL MODULE: ./src/assets/images/slides/fruition-slide-1.PNG
var fruition_slide_1 = __webpack_require__(87);
var fruition_slide_1_default = /*#__PURE__*/__webpack_require__.n(fruition_slide_1);
// EXTERNAL MODULE: ./src/assets/images/slides/fruition-slide-2.PNG
var fruition_slide_2 = __webpack_require__(942);
var fruition_slide_2_default = /*#__PURE__*/__webpack_require__.n(fruition_slide_2);
// EXTERNAL MODULE: ./src/assets/images/slides/jsleeve-slide-0.PNG
var jsleeve_slide_0 = __webpack_require__(269);
var jsleeve_slide_0_default = /*#__PURE__*/__webpack_require__.n(jsleeve_slide_0);
// EXTERNAL MODULE: ./src/assets/images/slides/jsleeve-slide-1.PNG
var jsleeve_slide_1 = __webpack_require__(175);
var jsleeve_slide_1_default = /*#__PURE__*/__webpack_require__.n(jsleeve_slide_1);
// EXTERNAL MODULE: ./src/assets/images/slides/jsleeve-slide-2.PNG
var jsleeve_slide_2 = __webpack_require__(653);
var jsleeve_slide_2_default = /*#__PURE__*/__webpack_require__.n(jsleeve_slide_2);
;// CONCATENATED MODULE: ./src/modules/modalText.js
...
const modalText = {
    fruition: {
        ...
        images: [
            (fruition_slide_0_default()),
            (fruition_slide_1_default()),
            (fruition_slide_2_default())
        ]
    },
    jsleeve: {
        title: "Synergy Svn",
        ...
        images: [
            (jsleeve_slide_0_default()),
            (jsleeve_slide_1_default()),
            (jsleeve_slide_2_default())
        ]
    }
};

/* harmony default export */ const modules_modalText = (modalText);
;// CONCATENATED MODULE: ./src/modules/setProjectInfo.js



const setProjectInfo = (id) => {
    const projectTitle = document.querySelector(".modal .title");
    projectTitle.innerHTML = modules_modalText[id].title;

    const projectInfo = document.querySelector(".modal .info");
    projectInfo.innerHTML = modules_modalText[id].info;

    const projectDetails = document.querySelector(".modal .details");
    projectDetails.innerHTML = modules_modalText[id].details;

    const projectLink = document.querySelector(".modal .link");
    projectLink.href = modules_modalText[id].link;

    const modalSlides = document.querySelectorAll(".modal .slide");
    modalSlides.forEach((slide, index) => {
        slide.style.background = `url(${modules_modalText[id].images[index]}) center center/cover`;
        slide.style.backgroundSize = "cover";
    });
};

/* harmony default export */ const modules_setProjectInfo = (setProjectInfo);
;// CONCATENATED MODULE: ./src/modules/setProjectButtons.js
...
const setProjectButtons = () => {
    ...
    projectButtons.forEach(button => {
        button.addEventListener("click", modules_setModal);
        button.addEventListener("click", () => {
            modules_setProjectInfo(button.id);
        });
    });
};


/* harmony default export */ const modules_setProjectButtons = (setProjectButtons);
;// CONCATENATED MODULE: ./src/modules/setModalEvents.js
...
/* harmony default export */ const modules_setModalEvents = (setModalEvents);
;// CONCATENATED MODULE: ./src/modules/shiftSlide.js
...
/* harmony default export */ const modules_shiftSlide = (shiftSlide);
...
/* harmony default export */ const modules_contact = (contact);
...
window.addEventListener('scroll', modules_fixNav);
window.addEventListener('scroll', modules_setHighlightTextEvent);
document.querySelector(".bar-icon").addEventListener("click", modules_toggleMobileNav);
modules_onScrollInit(document.querySelectorAll(".waypoint"));
modules_setNavLinksEvents();
modules_setProjectButtons();
modules_setModalEvents();
modules_contact();
})();
